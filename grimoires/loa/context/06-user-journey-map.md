...
| Z6 | Observatory Plaza · "the lobby" (`purupuru-blink.vercel.app/`) | 1F · public square | LIVE | **A lobby you enter into, not a dashboard you read.** The pentagram canvas IS the room — sprites of every puruhani drift through their element-zone, you see your community arrive in real time as new stones land. Above the room, a four-tile clan census (live presence · stones claimed · quizzes taken · dominant element with kanji) shows which way the world is tilting tonight. To the right, an event ticker calls out arrivals + quiz completions + element shifts the moment they happen. Below that, a weather pane reads the user's local sky and tells the room which element it amplifies — the offline world bleeding into the online one. Music + day/night theme close the seal. **Most finished zone.** | Direct URL only | Click sprite → Z7 | zerker (main) |

...
export const SITE = {
  ...
  name: "purupuru",
  handle: "@puruworld",
  // OG image is generated by Next.js file convention at `app/opengraph-image.tsx`
  // and auto-injected into metadata. No external asset URL needed — Next.js
  // auto-routes /opengraph-image and populates `images` for openGraph + twitter.
  // (Prior thj-assets S3 URL returned 403 · Discord/X couldn't render it.)
  ogWidth: 1200,
  ogHeight: 630,
...
// at `app/opengraph-image.tsx` auto-populates both for the root + all child

<!-- Operator-managed override of .claude/loa/CLAUDE.loa.md -->
<!-- Drops L1-L7 Agent-Network audit primitives (~125 lines) — not used in this project. -->
<!-- Mirrors framework v1.130.0 lines 1-292 + 420-424 verbatim. -->
<!-- To regenerate: copy current .claude/loa/CLAUDE.loa.md, strip the L1-L7 sections (Agent-Network Audit Envelope through L7 Soul-Identity-Doc), keep Conventions footer. -->
...
<!-- L1-L7 Agent-Network audit primitives intentionally omitted from this lite override. -->
<!-- See .claude/loa/CLAUDE.loa.md (framework) for full L1-L7 spec if you wire one up. -->

 ...
 */
export async function computeCacheKey(hasher, headSha, truncationLevel, convergencePromptHash, selfReviewState = "inactive") {
    // Boolean callers (iter-2 contract): true → "active", false → "inactive".
    // Iter-5 callers pass the tri-state directly.
    const state = typeof selfReviewState === "boolean"

 ...
 */
export function checkDepth(reviewContent, config) {
    ...
    for (const [key, patterns] of Object.entries(ELEMENT_PATTERNS)) {
        elements[key] = patterns.some((p) => p.test(reviewContent));
    }
 ...
 */
export async function logDepthResult(result, meta, logPath) {
...
//# sourceMappingURL=depth-checker.js.map